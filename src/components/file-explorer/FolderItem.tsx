                  ...
                  selectionVisible
                    ...
                    : cn(
                        ...
                        selectionHoverEnabled &&
                          "group-hover:pointer-events-auto group-hover:mr-1.5 group-hover:w-4 group-hover:opacity-100 group-focus:pointer-events-auto group-focus:mr-1.5 group-focus:w-4 group-focus:opacity-100 group-focus-within:pointer-events-auto group-focus-within:mr-1.5 group-focus-within:w-4 group-focus-within:opacity-100"
                      )
                )}
