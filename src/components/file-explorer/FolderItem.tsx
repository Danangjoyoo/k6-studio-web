      ...
      <div>
        ...
        >
          <div className="flex min-w-0 items-center">
              ...
              <span
                ...
                className={cn(
                  ...
                  selectionVisible
                    ...
                    : "pointer-events-none mr-0 w-0 opacity-0 group-hover:pointer-events-auto group-hover:mr-1.5 group-hover:w-4 group-hover:opacity-100 group-focus:pointer-events-auto group-focus:mr-1.5 group-focus:w-4 group-focus:opacity-100 group-focus-within:pointer-events-auto group-focus-within:mr-1.5 group-focus-within:w-4 group-focus-within:opacity-100"
                )}
            ...
            {open ? (
              <FolderOpen className="mr-1.5 h-3.5 w-3.5 shrink-0 text-primary/60" />
            ) : (
              <Folder className="mr-1.5 h-3.5 w-3.5 shrink-0 text-primary/60" />
            )}
            {editing ? (
              <input
                ref={inputRef}
